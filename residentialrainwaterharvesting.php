...
<div class="w3-row-padding w3-padding-64 w3-theme-l1" id="work">
  ...
  <div class="w3-card w3-white">
    ...
    <p>If  the  rainwater  is  collected  using  appropriate
infrastructure, it can contribute greatly to the volume of freshwater available
for  human  use.  This  is  particularly  relevant  in  arid  and  semi-arid  regions,
where  the  little  rainfall  received  is  usually  very  intense  and  often  seasonal rainwater harvesting method helps a lot. </p>
<p> </p>
<p><b>For Complete Guidence -</b> </p>
  <p style="color:rgb(0, 17, 255);">- Informative Article -</p>
  <button
    onClick="window.location.href='https://www.ctc-n.org/sites/www.ctc-n.org/files/UNFCCC_docs/ref02x16_7.pdf';">
    Click Here
  </button>
  <p style="color:rgb(0, 17, 255);">- Technical Video -</p>
  <!-- <iframe width="260" height="345" src="https://youtu.be/ES8-xHQ10ww">
  </iframe> -->
  <iframe width="260" height="345" src="https://www.youtube.com/embed/RrKipLRwwzM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
